    ...
    <div class="flex-1 lg:px-10 py-8">
        <div class="pl-4">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="flex items-center">
                            ...
                            <p class="text-sm">{{ $jobFinder->age }}歳 {{ $jobFinder->gender->label() }}</p>
                        </div>
            ...
            @else
                ...
                <p class="relative left-14">{{ $jobFinder->age }}歳 {{ $jobFinder->gender->label() }}</p>
        ...
        <div class="mt-6">
            <table class="w-full">
                ...
                <tr class="border-y-2">
                    ...
                    <td>
                        {{ $jobFinder->employment_pattern->label() }}
